...
import com.daewon.xeno_backend.security.handler.Custom403Handler;
...
//        http.addFilterBefore(loginFilter, UsernamePasswordAuthenticationFilter.class);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000","https://www.xeno-brand.store","https://www.xeno-manager.store","https://www.xeno-manager.store"));
