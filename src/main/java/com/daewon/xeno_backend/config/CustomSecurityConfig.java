...
//        corsConfiguration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000","https://www.xeno-brand.store","https://www.xeno-manager.store","https://www.fo-xeno.store"));
