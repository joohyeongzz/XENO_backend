...
//        http.addFilterBefore(loginFilter, UsernamePasswordAuthenticationFilter.class);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000","https://www.xeno-brand.store","https://www.xenomanager.store","https://www.foxeno.store"));
